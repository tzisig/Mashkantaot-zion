...
faqs:
  ...
  - q: מגיל כמה אפשר?
    a: הגיל המינימלי נקבע על ידי הגוף המלווה ומשתנה ביניהם. זה אחד הדברים שצריך לברר מול כל גוף בנפרד.
  - q: מה קורה עם הירושה?
...
כמה אפשר לקבל, מאיזה גיל, ובאיזו ריבית, נקבע אצל כל גוף בנפרד. את הגופים האלה חשוב להכיר: לפי מה שפורסם בתקשורת הכלכלית, רוב מי שמציע היום משכנתא הפוכה בישראל הם חברות ביטוח וגופים חוץ בנקאיים, הפועלים תחת פיקוח רשות שוק ההון, ביטוח וחיסכון. משמעות הדבר היא שהתנאים אינם אחידים, וההשוואה ביניהם היא חלק מהעבודה. [NEEDS SOURCE: אסמכתה רשמית לגיל המינימלי ולתקרות המימון - לא מצאתי מקור ממשלתי שמפרט אותם]
