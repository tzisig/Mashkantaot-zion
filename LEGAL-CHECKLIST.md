...
Everything here must be reviewed by a lawyer before the site goes live. If the site is sold, the buyer's lawyer signs off.

| # | Item | Why | Status |
|---|---|---|---|
| 1 | Brokering non-bank loans (`/services/non-bank-loans`) | May require a license from the Capital Market Authority (Financial Services Supervision law) | Open |
| 2 | Mortgage advisor licensing bill | Approved for first reading 2026-05-26; will require registry + exam. Never write "licensed" / "certified" until true. Keep a config field for a future license number | Watch |
| 3 | Privacy policy | Must match exactly what the site collects (form, GA4, Meta/TikTok pixels), incl. Amendment 13 notice duty | Open |
| 4 | Terms of use + cookie policy | Consent banner, Consent Mode v2 | Open |
| 5 | Accessibility statement | IS 5568 / WCAG 2.0 AA, accessibility coordinator details | Open |
